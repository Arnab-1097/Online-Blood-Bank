...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images\jfghjfjf.png"   class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images\mvbnm.jpg"  class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images\oyioyo.png"  class="d-block w-100" alt="...">
    </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-12 ">
        <img src="images\hgfhfg.jpg" class="img-fluid aboutimg" >
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-12 py-5">
        <div class="card" >
          <img class="card-img-top aboutimg" src="images\dasdasgfsg.jpg" alt="Card image">
        <div class="card-body">
      ...
      <div class="col-lg-6 col-md-6 col-12 py-5">
        <div class="card" >
          <img class="card-img-top aboutimg" src="images\adasd.png" alt="Card image">
        <div class="card-body">
